...
public class RobotMap {
    ...
    public static PowerDistributionPanel pDPSystemPowerDistributionPanel1;
    ...
    public static void init() {
        ...
        pDPSystemPowerDistributionPanel1 = new PowerDistributionPanel(0);
        LiveWindow.addSensor("PDPSystem", "PowerDistributionPanel 1", pDPSystemPowerDistributionPanel1);
