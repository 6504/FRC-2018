...
public class DriveTrain extends Subsystem {
    ...
    //Default command to drive in TeleOp
    @Override
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("Gyro angle", RobotMap.gyro.getAngle()); //Transmit gyro angle
        SmartDashboard.putNumber("Match Time", DriverStation.getInstance().getMatchTime()); //Get match time
    }

    // Put methods for controlling this subsystem
    // here. Call these from Commands.
    
    //Xbox axes method to steer; simulating z-axis while reducing sensitivity for two joysticks
    ...
    //Logitech axis method to steer; using one joystick
    ...
    //Stop method, stops all drive motors
    public void stop() {
    	frontLeft.set(0);  
    	backLeft.set(0);
    	frontRight.set(0);
