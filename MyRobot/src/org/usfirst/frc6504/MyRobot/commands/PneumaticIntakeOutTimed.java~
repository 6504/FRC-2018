 ...
 *
 */
public class PneumaticIntakeOutTimed extends Command {
    ...
    public PneumaticIntakeOutTimed() {
    ...
    protected void execute() {
    	...
    	RobotMap.pneumaticsSubsystemDoubleSolenoid1.set(DoubleSolenoid.Value.kReverse);
    }
