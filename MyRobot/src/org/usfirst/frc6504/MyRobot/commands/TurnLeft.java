...
public class TurnLeft extends Command {
    ...
    //Define the drivetrain so it can be used later
    ...
    protected boolean isFinished() {
        return RobotMap.gyro.getAngle() <= -75.0; //Attempt to turn -90 degrees while compensating for coasting
    }
