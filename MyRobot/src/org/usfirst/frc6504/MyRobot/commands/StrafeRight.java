...
public class StrafeRight extends Command {
    ...
    protected void initialize() {
    	RobotMap.gyro.reset(); //Reset gyro angle 0
    	setTimeout(1.5);
    }
    ...
    protected void execute() {
    	...
    	//Drive robot to the right side using the opposite of the product of the gyro angle and Kp to keep straight 
    	robotDrive.driveCartesian(0.6, 0, -angle*Kp);	
    }
