...
public class DriveRightDiagonally extends Command {
    ...
    protected void initialize() {
    	RobotMap.gyro.reset();
    	setTimeout(1); //TO-DO: Adjust time so robot drives directly to the scale 
    }
    ...
    protected void execute() {
    	...
    	robotDrive.drivePolar(.8, -27.5, -angle*Kp); //TO-DO: Adjust angle so robot drives directly to the scale
    }
