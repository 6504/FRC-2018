 ...
 *
 */
public class Turn__DegreesLeft extends Command {
    ...
    protected void initialize() {
    	RobotMap.gyro.reset(); //Reset angle
    }
    ...
    protected boolean isFinished() {
        return RobotMap.gyro.getAngle() <= 15.0; //TO-DO: Adjust angle accordingly
    }
