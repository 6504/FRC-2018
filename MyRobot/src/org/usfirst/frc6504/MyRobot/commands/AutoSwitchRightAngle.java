 ...
 *
 */
public class AutoSwitchRightAngle extends Command {
    ...
    protected boolean isFinished() {
        return RobotMap.gyro.getAngle() <= -85; //Attempt to turn -90 degrees while compensating for coast
    }
