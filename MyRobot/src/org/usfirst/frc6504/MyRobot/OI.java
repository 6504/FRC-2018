...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("Auto Scale Drive Backwards Left", new AutoScaleDriveBackwardsLeft());
        ...
        SmartDashboard.putData("Drive Left Forward More", new DriveLeftForwardMore());
        SmartDashboard.putData("Drive Right Forward More", new DriveRightForwardMore());
        SmartDashboard.putData("Auto Scale Drive Backwards Right", new AutoScaleDriveBackwardsRight());
