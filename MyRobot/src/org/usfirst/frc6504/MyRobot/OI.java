...
public class OI {
    ...
    public JoystickButton intakeGrabButton;
    public JoystickButton intakeReleseButton;
    ...
    public OI() {
        ...
        intakeReleseButton = new JoystickButton(xbox360joyStick1, 1);
        intakeReleseButton.whenReleased(new IntakeOut());
        intakeGrabButton = new JoystickButton(xbox360joyStick1, 1);
        intakeGrabButton.whileHeld(new IntakeIn());
