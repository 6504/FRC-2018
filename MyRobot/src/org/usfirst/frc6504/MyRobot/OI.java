...
public class OI {
    ...
    public JoystickButton xboxbuttonA2;
    ...
    public OI() {
        ...
        logitechJoystick0 = new Joystick(0);
        
        liftUpButton = new JoystickButton(logitechJoystick0, 5);
        liftUpButton.whileHeld(new LiftUp());
        xbox360joyStick1 = new Joystick(1);
        
        xboxbuttonA2 = new JoystickButton(xbox360joyStick1, 1);
        xboxbuttonA2.whenReleased(new PneumaticPistonRetract());
        xboxbuttonA = new JoystickButton(xbox360joyStick1, 1);
        xboxbuttonA.whenPressed(new PneumaticPistonExtend());
        ...
        SmartDashboard.putData("PneumaticPistonExtend", new PneumaticPistonExtend());
        SmartDashboard.putData("PneumaticPistonRetract", new PneumaticPistonRetract());
